...
- **Позволяет менять модель на ходу** и сравнивать ответы разных Qwen на одних вопросах.
...
| [Roadmap](docs/roadmap.md) | План развития: мультимодельность, retrieval, guardrails, официальные источники |
